...
WARNING: Dieser Anwendungsfall wird deprecated und nur bis voraussichtlich Mitte 2025 unterstützt. Er sollte unter Verwendung von `GET /PKICertificates` umgesetzt werden. Daher wird er hier entfernt, um eine weitere Implementierung zu vermeiden.
