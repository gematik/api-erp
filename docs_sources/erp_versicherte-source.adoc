...
----
include::../resources/examples/ti-dienste/task/versicherte/response_taskGetAll.json[]
----
...
NOTE: Wenn ein Task den Status "in-progress" hat und das Feld Task.extension:lastMedicationDispense ausgefüllt ist, müssen dem Task auch Abgabeinformationen zur Verfügung stehen. Der Status des E-Rezepts könnte dann als "Abgegeben" dargestellt werden. Bis der Task nicht abgeschlossen ist, können diese gelöscht oder geändert werden. Dabei wird das Feld lastMedicationDispense aktualisiert. Nach Abschluss des Workflows wird der Status auf "complete" gesetzt, und eine Änderung der Abgabeinformationen ist nicht mehr möglich.
...
[source,json]
----
include::../resources/examples/ti-dienste/task/versicherte/response_taskGetSingle.json[]
----
...
[source,json]
----
include::../resources/examples/ti-dienste/apovzd/response_GetLocation.json[]
----
...
[source,json]
----
include::../resources/examples/ti-dienste/erp/response_getDispense.json[]
----
...
NOTE: Wenn ein Task den Status "in-progress" hat und das Feld Task.extension:lastMedicationDispense ausgefüllt ist, müssen dem Task auch Abgabeinformationen zur Verfügung stehen. Bis der Task nicht abgeschlossen ist, können diese gelöscht oder geändert werden. Dabei wird das Feld lastMedicationDispense aktualisiert. Nach Abschluss des Workflows wird der Status auf "complete" gesetzt, und eine Änderung der Abgabeinformationen ist nicht mehr möglich.
...
[source,json]
----
include::../resources/examples/ti-dienste/medicationdispense/response_get-single-medicationdispense-by-id.json[]
----
NOTE: Der Task wird unter `"reference":"Task/160.880.966.157.248.22"` des eingelösten E-Rezepts referenziert. Über den Link können weitere Informationen wie E-Rezept-Datensatz und ggfs. die Quittung abgerufen werden.
...
[source,json]
----
include::../resources/examples/ti-dienste/medicationdispense/response_get-multiple-medication-dispense.json[]
----
NOTE: Der Task wird unter `"reference":"Task/160.880.966.157.248.22"` des eingelösten E-Rezepts referenziert. Über den Link können weitere Informationen wie E-Rezept-Datensatz und ggfs. die Quittung abgerufen werden.
...
[source,json]
----
include::../resources/examples/ti-dienste/erp/response_getAuditEvent.json[]
----
