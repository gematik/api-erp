...
| Sammlung von vier E-Rezept-Referenzen in einem 2D-Code +
[source,json]
----
{
  "urls": [
...
^.^| image:datamatrix_sample_4.png[width=250px]
...
WARNING: WARNING: Beim Übergang von einer Profilversion der Workflow-Profile zu einer anderen kann es sein, dass GET /MedicationDispense mehrere Versionen zurückgibt. Im Folgenden ein Beispiel für genau diesen Fall:
