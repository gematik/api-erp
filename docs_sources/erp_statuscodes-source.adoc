...
.2+|GET /Task                 |200            |Tasks konnten erfolgreich gelesen werden
                              |202            |Die Anfrage wurde erfolgreich angenommen, mit einem Prüfungsnachweis, der das Ergebnis "3" enthält.
...
.8+|GET /Task                 |400            |Ungültiger http-Request
                              ...
                              |454            |Der E-Rezept-Fachdienst akzeptiert zu diesem Zeitpunkt keine Anfragen mit einem Prüfungsnachweis, der das Ergebnis "3" enthält.
                              |455            |Die kvnr als URL-Parameter nicht angegeben
