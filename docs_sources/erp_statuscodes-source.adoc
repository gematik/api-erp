...
Dies ist ein Beispiel für eine OperationOutcome, in der ein Abruf nicht erlaubt ist, da sich der Task in einem entsprechenden Status befindet. Siehe Fehlercode 409 aus link:./erp_abrufen.adoc#E-Rezeptabrufen[E-Rezept abrufen].
