...
include::../resources/openapi-adoc/bfarm/t-prescription-json-fhir_POST_Request.adoc[]

include::../resources/openapi-adoc/bfarm/t-prescription-json-fhir_POST_Response.adoc[]