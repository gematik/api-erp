...
4+|
//
|Apothekenpflichtige Arzneimittel für Privatversicherte |:heavy_check_mark: |  | Bereitstellung durch den E-Rezept-Fachdienst ist erfolgt. Verbreitung im Feld ist derzeit noch nicht gegeben.
//
|verschreibungspflichtige Arzneimittel für Privatversicherte |:heavy_check_mark: |  | Bereitstellung durch den E-Rezept-Fachdienst ist erfolgt. Verbreitung im Feld ist derzeit noch nicht gegeben.
//
|[.underline]#nicht# verschreibungspflichtige Arzneimittel für Privatversicherte |:heavy_check_mark: |  | Übergangslösung mit Workflow 200: Planung der Bereitstellung in PU ist Mitte 2023
//
