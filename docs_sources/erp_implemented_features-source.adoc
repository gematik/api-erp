...
//
|T-Rezepte (Kennzeichnung) |:soon: | :heavy_check_mark: | z.B. Arzneimittel mit den Wirkstoffen Lenalidomid, Pomalidomid und Thalidomid. Auf RU-Dev verfügbar. Pilotierung ab 01.12.2026 geplant.
