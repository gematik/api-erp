...
|gematik de.gematik.erezept-workflow.r4 |link:https://simplifier.net/packages/de.gematik.erezept-workflow.r4/1.3.0-rc1[Package 1.3.0-rc1 Profile 1.3^] a|
...
* Datumsvalidierung für MedicationDispense bei $close und $dispense
