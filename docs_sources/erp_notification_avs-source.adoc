...
[source,xml]
----
include::../resources/examples/vau/request_PostSubscriptionPseudo.xml[]
----
...
[source,xml]
----
include::../resources/examples/vau/response_PostSubscriptionPseudo.xml[]
----
...
[source,c++]
----
include::../resources/examples/vau/ping_Subscription.cpp[]
----
