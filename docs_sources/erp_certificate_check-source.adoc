...
[source,json]
----
include::https://raw.githubusercontent.com/gematik/eRezept-Examples/refs/heads/{branch}/api-examples/generated-examples//certificate_check/03_response_pkicertificates.json[]
----
...
link:https://raw.githubusercontent.com/gematik/eRezept-Examples/{branch}/api-examples/generated-examples/certificate_check/04_response_ocspResponse.der[OCSP Response]
