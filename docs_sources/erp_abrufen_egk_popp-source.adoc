...
* link:https://gemspec.gematik.de/docs/gemSpec/gemSpec_PoPP_Service/gemSpec_PoPP_Service_V1.0.0_CC2/[Spezifikation PoPP-Service]
...
* der Zeitstempel des PoPP-Token innerhalb des Akzeptanzzeitraumes (30 Minuten) ist.
