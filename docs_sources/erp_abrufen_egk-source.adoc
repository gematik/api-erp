= E-Rezept API-Dokumentation für Apotheken (Einlösung mit Gesundheitskarte mittels VSDM) image:gematik_logo.png[width=150, float="right"]
...
WARN: Dieser Anwendungsfall ist ´deprecated´ und wird durch die link:./erp_abrufen_egk_popp.adoc[Verwendung des PoPP-Tokens] abgelöst.

==  Anwendungsfall Liste einlösbarer E-Rezepte abrufen mit Stecken der Gesundheitskarte mittels VSDM
...
[source,xml]
----
include::https://raw.githubusercontent.com/gematik/eRezept-Examples/{branch}/api-examples/generated-examples/erp_abrufen_egk/01_GetCards.xml[]
----
...
[source,xml]
----
include::https://raw.githubusercontent.com/gematik/eRezept-Examples/{branch}/api-examples/generated-examples/erp_abrufen_egk/02_GetCards_Response.xml[]
----
...
[source,xml]
----
include::https://raw.githubusercontent.com/gematik/eRezept-Examples/{branch}/api-examples/generated-examples/erp_abrufen_egk/03_ReadVSD.xml[]
----
...
[source,xml]
----
include::https://raw.githubusercontent.com/gematik/eRezept-Examples/{branch}/api-examples/generated-examples/erp_abrufen_egk/04_03_ReadVSD_Response_Secunet.xml[]
----
...
[source,xml]
----
include::https://raw.githubusercontent.com/gematik/eRezept-Examples/{branch}/api-examples/generated-examples/erp_abrufen_egk/05_Response_Task.xml[]
----
