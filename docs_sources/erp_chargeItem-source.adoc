...
[source,json]
----
include::https://raw.githubusercontent.com/gematik/fhir-profiles-erpchrg/refs/heads/feature/patch-chargeitem-update/Resources/fsh-generated/resources/Parameters-Example-Parameters-Patch-ChargeItem-2.json[]
