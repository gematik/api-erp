...
[source,json]
----
include::https://raw.githubusercontent.com/gematik/eRezept-Examples/refs/heads/{branch}/API-Examples/{date-folder}/erp_chargeItem/08_GET_ChargeItems_response.json[]
----
