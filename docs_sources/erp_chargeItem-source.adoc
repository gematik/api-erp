...
[source,xml]
----
include::../resources/examples/konnektorservice/request_SignDocument_Abgabedaten.xml[]
----
...
[source,xml]
----
include::../resources/examples/konnektorservice/response_SignDocument_Abgabedaten.xml[]
----
