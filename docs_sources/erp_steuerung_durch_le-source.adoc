...
Der KIM-Header "KIM-Encounter-Id" ist für die Nachvollziehbarkeit des Nachrichtenaustauschs ebenfalls zu setzen, siehe link:https://github.com/gematik/api-kim/blob/develop/docs/Primaersystem.adoc#43-nachrichten-versenden[API-KIM: Nachrichten Versenden].
