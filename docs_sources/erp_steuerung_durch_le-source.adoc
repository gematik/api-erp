...
[source,text]
----
include::https://raw.githubusercontent.com/gematik/eRezept-Examples/{branch}/API-Examples/{date-folder}/erp_steuerung_durch_le/05_emailPlainZuweisungInDerApotheke.txt[]
----
...
[source,text]
----
include::https://raw.githubusercontent.com/gematik/eRezept-Examples/{branch}/API-Examples/{date-folder}/erp_steuerung_durch_le/06_emailPlainFreieKommunikation.txt[]
----
NOTE: `Subject` enthält den wählbaren Titel der Nachricht. 
...
[source,text]
----
include::https://raw.githubusercontent.com/gematik/eRezept-Examples/{branch}/API-Examples/{date-folder}/erp_steuerung_durch_le/07_emailPlainFreieKommunikation_reply.txt[]
----
NOTE: `Subject` enthält den wählbaren Titel der Nachricht. 
...
include::https://raw.githubusercontent.com/gematik/eRezept-Examples/{branch}/API-Examples/{date-folder}/erp_steuerung_durch_le/08_response_taskGet169Versicherter.json[]
----
