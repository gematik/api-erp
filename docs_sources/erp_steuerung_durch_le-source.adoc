...
[source,xml]
----
include::../resources/examples/ti-dienste/task/169/request_taskCreate169.xml[]
----
...
[source,xml]
----
include::../resources/examples/ti-dienste/task/169/response_taskCreate169.xml[]
----
...
[source,xml]
----
include::../resources/examples/ti-dienste/task/169/request_taskActivate169.xml[]
----
...
[source,xml]
----
include::../resources/examples/ti-dienste/task/169/response_taskActivate169.xml[]
----
...
Der KIM-Header "KIM-Encounter-Id" dient dazu, Nachrichten zu gruppieren, insbesondere im Zusammenhang mit einem Behandlungskontext. Diese ID sollte zu Beginn einer Nachrichtenkonversation festgelegt und bei der Beantwortung von empfangenen Nachrichten beibehalten werden. Weitere Informationen finden Sie in der Dokumentation unter dem folgenden Link link:https://github.com/gematik/api-kim/blob/develop/docs/Primaersystem.adoc#43-nachrichten-versenden[API-KIM: Nachrichten Versenden].
...
[source,text]
----
include::../resources/examples/kim/emailPlainZuweisungInDerApotheke.txt[]
----
...
[source,text]
----
include::../resources/examples/kim/emailPlainFreieKommunikation.txt[]
----
NOTE: `Subject` enthält den wählbaren Titel der Nachricht. Es dürfen keine personenbezogenen oder medizinischen Informationen enthalten sein. +
...
[source,text]
----
include::../resources/examples/kim/emailPlainFreieKommunikation_reply.txt[]
----
NOTE: `Subject` enthält den wählbaren Titel der Nachricht. Es dürfen keine personenbezogenen oder medizinischen Informationen enthalten sein. +
...
[source,json]
----
include::../resources/examples/ti-dienste/task/169/response_taskGet169Versicherter.json[]
----
