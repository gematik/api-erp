...
include::../resources/openapi-adoc/e_prescription/Consent_DELETE.adoc[]
...
include::../resources/openapi-adoc/e_prescription/Consent_GET.adoc[]

== Erstellen eines Zugriffscodes für das Einlösen im EU-Ausland

=== Erstellen des Zugriffscodes im E-Rezept-Fachdienst 

include::../resources/openapi-adoc/e_prescription/$grant-eu-access-permission_POST.adoc[]

=== Abfragen des Zugriffscodes im E-Rezept-Fachdienst

include::../resources/openapi-adoc/e_prescription/$read-eu-access-permission_GET.adoc[]

=== Löschen des Zugriffscodes im E-Rezept-Fachdienst

include::../resources/openapi-adoc/e_prescription/$revoke-eu-access-permission_DELETE.adoc[]
...
include::../resources/openapi-adoc/e_prescription/$get-eu-prescriptions_POST.adoc[]
...
include::../resources/openapi-adoc/e_prescription/Task_id_$eu-close_POST.adoc[]
