...
[source,json]
----
include::https://raw.githubusercontent.com/gematik/fhir-profiles-erp/refs/heads/feature/workflow-1-5/Resources/fsh-generated/resources/Bundle-ExampleGetConsent.json[]
----
