...
[cols="h,a", separator=¦]
|===
¦URI        ¦https://erp.app.ti-dienste.de/$get-prescription
¦Method     ¦POST
...
<Parameters xmlns="http://hl7.org/fhir">
    ...
    <parameter>
        ...
        <part>
            ...
            <valueCoding>
                <system value="https://gematik.de/fhir/erp/CodeSystem/GEM_ERP_CS_HealthCareFacilityType_EU"/>
                <code value="apotheke"/>
            </valueCoding>
        </part>
    </parameter>
