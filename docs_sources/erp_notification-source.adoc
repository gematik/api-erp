...
Eine Open API Datei für die Fachdienst Schnittstellen findet sich unter: link:../respurces/openapi/OpenApi_Notification_E-Rezept-Fachdienst_v1_0_0.yaml[Fachdienst Notifications Open API]
