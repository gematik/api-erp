...
IMPORTANT: Ab dem 01.10.2026 unterstützt der E-Rezept-Fachdienst Version 3 des Payloads der Communication-Ressource. Weitere Informationen hierzu sind auf link:./erp_communication_v3.adoc[hier] und link:./erp_communication_change_20261001.adoc[hier] zu finden.
...
NOTE: Der Aufruf ist aus Performance Gründen nicht für die regelmäßige Abfrage von Nachrichten vorgesehen. Es soll nur nach neuen Nachrichten geprüft werden, wenn der Nutzer aktiv eine Aktion ausführt, die eine solche Prüfung erfordert oder in der App ein "refresh" der Daten durchgeführt wird. Falls mehrere E-Rezept-Nachrichten auf dem E-Rezept-Fachdienst bereitstehen, übermittelt der E-Rezept-Fachdienst ein Bundle (bestehend aus max. 50 Elementen) von Communication Ressourcen. In Erwartung von mehr als 50 Elementen, wird ein Paging empfohlen.
