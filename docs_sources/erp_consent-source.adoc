...
[source,json]
----
include::../resources/examples/prescriptionserver/request_PostConsent.json[]
----
|===
...
[source,json]
----
include::../resources/examples/prescriptionserver/response_PostConsent.json[]
----
...
[source,json]
----
include::../resources/examples/prescriptionserver/response_GetConsent.json[]
----
