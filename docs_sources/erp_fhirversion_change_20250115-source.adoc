...
| $accept-Bundle | Korrektur der Referenz auf die Verordnung. Hinzufügen des Ressourcetypes in der Referenz
...
* Im $accept-Bundle wird die Referenz auf die Verordnung korrigiert. In der Referenz des Tasks auf die Verordnung wird der RessourcenTyp mit angegeben.
