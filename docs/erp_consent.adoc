...
Die Profile können als JSON- oder XML-Datei hier eingesehen werden: https://simplifier.net/erezept-abrechnungsinformationen/gem_erp_pr_consent
    ...
    "category":  [
        {
            "coding":  [
                {
                    "code": "CHARGCONS",
                    "system": "https://gematik.de/fhir/erpchrg/CodeSystem/ConsentType",
