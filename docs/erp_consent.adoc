...
[source,json]
----
include::resources/prescriptionserver/request_PostConsent.json[]
----
|===
...
[source,json]
----
include::resources/prescriptionserver/response_PostConsent.json[]
----
...
[source,json]
----
include::resources/prescriptionserver/response_GetConsent.json[]
----
