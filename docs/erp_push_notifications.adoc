...
[%autowidth]
|===
¦URI        ¦https://erp.zentral.erp.splitdns.ti-dienste.de/v1/pushers/set
¦Method     ¦POST
¦Requester  ¦image:{FdV}[]
¦HTTP Header ¦
----
...
[%autowidth]
|===
¦URI        ¦https://erp.zentral.erp.splitdns.ti-dienste.de/v1/pushers
¦Method     ¦GET
¦Requester  ¦image:{FdV}[]
¦HTTP Header ¦
----
...
[%autowidth]
|===
¦URI        ¦https://erp.zentral.erp.splitdns.ti-dienste.de/v1/channels
¦Method     ¦GET
¦Requester  ¦image:{FdV}[]
¦HTTP Header ¦
----
...
[%autowidth]
|===
¦URI        ¦https://erp.zentral.erp.splitdns.ti-dienste.de/v1/channels/<pushkey>
¦Method     ¦GET
¦Requester  ¦image:{FdV}[]
¦HTTP Header ¦
----
