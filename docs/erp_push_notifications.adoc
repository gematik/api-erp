...
NOTE: Diese Operationen müssen über das VAU Protokoll durchgeführt werden.
...
[%autowidth]
|===
¦URI ¦https://erp.zentral.erp.splitdns.ti-dienste.de/pushers/v1/set
¦Method ¦POST
¦Requester ¦image:{FdV}[]
¦HTTP Header ¦
----
...
----
====
.Response Body (400) für malformedRequest (Klicken zum Ausklappen)
[%collapsible]
====
[source,json]
----
...
----
====
.Response Body (400) für missingParameter (Klicken zum Ausklappen)
[%collapsible]
====
[source,json]
----
{
  ...
  "errorDetail": "Fehlender Parameter im http-Request"
}
----
====
.Response Body (400) für invalidParameter (Klicken zum Ausklappen)
[%collapsible]
====
[source,json]
----
{
  ...
  "errorDetail": "Ungültiger Parameter im http-Request"
}
----
====
.Response Body (401) (Klicken zum Ausklappen)
[%collapsible]
====
[source,json]
----
...
----
====
.Response Body (403) (Klicken zum Ausklappen)
[%collapsible]
====
[source,json]
----
...
----
====
.Response Body (408) (Klicken zum Ausklappen)
[%collapsible]
====
[source,json]
----
...
----
====
.Response Body (429) (Klicken zum Ausklappen)
[%collapsible]
====
[source,json]
----
...
----
====
.Response Body (500) (Klicken zum Ausklappen)
[%collapsible]
====
[source,json]
----
{
  ...
  "errorDetail": "Interner Serverfehler"
}
----
====
...
[%autowidth]
|===
¦URI ¦https://erp.zentral.erp.splitdns.ti-dienste.de/pushers/v1
¦Method ¦GET
¦Requester ¦image:{FdV}[]
¦HTTP Header ¦
----
...
----
====
.Response Body (400) (Klicken zum Ausklappen)
[%collapsible]
====
[source,json]
----
...
[%autowidth]
|===
¦URI ¦https://erp.zentral.erp.splitdns.ti-dienste.de/channels/v1
¦Method ¦GET
¦Requester ¦image:{FdV}[]
¦HTTP Header ¦
----
...
[%autowidth]
|===
¦URI ¦https://erp.zentral.erp.splitdns.ti-dienste.de/channels/v1/<pushkey>
¦Method ¦GET
¦Requester ¦image:{FdV}[]
¦HTTP Header ¦
----
