...
[source,xml]
----
include::resources/konnektorservice/request_ReadCardCertificate.xml[]
----
...
[source,xml]
----
include::resources/konnektorservice/response_ReadCardCertificate.xml[]
----
...
[source,xml]
----
include::resources/konnektorservice/request_VerifyCertificate.xml[]
----
...
HTTP/1.1 200 OK
Content-Type: text/xml;charset=utf-8
include::resources/konnektorservice/response_VerifyCertificate.xml[]
----
...
[source,xml]
----
include::resources/konnektorservice/request_ExternalAuthenticate.xml[]
----
...
HTTP/1.1 200 OK
Content-Type: text/xml;charset=utf-8
include::resources/konnektorservice/response_ExternalAuthenticate.xml[]
----
...
[source,json]
----
include::resources/vau/response_InnerVau.json[]
----
