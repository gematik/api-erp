...
<S:Envelope xmlns:S="http://schemas.xmlsoap.org/soap/envelope/"
  ...
  <SOAP-ENV:Header />
  <S:Body>
    <ns4:ReadCardCertificate xmlns:ns4="http://ws.gematik.de/conn/CertificateService/v6.0"
      ...
      <ns2:CardHandle>SMC-B-15</ns2:CardHandle>
      <ns3:Context>
      ...
      <ns4:Crypt>ECC</ns4:Crypt>
    </ns4:ReadCardCertificate>
  </S:Body>
</S:Envelope>
----
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  <SOAP-ENV:Header />
  <SOAP-ENV:Body>
    <ns5:ReadCardCertificateResponse xmlns:ns5="http://ws.gematik.de/conn/CertificateService/v6.0"
      xmlns:ns2="http://ws.gematik.de/conn/ConnectorCommon/v5.0"
        ...
        <ns4:X509DataInfo>
          ...
          <ns4:X509Data>
            <ns4:X509IssuerSerial>
              <ns4:X509IssuerName>CN=GEM.SMCB-CA57 TEST-ONLY,OU=Institution des Gesundheitswesens-CA
                der Telematikinfrastruktur,O=gematik NOT-VALID,C=DE</ns4:X509IssuerName>
              <ns4:X509SerialNumber>384074971647989</ns4:X509SerialNumber>
            </ns4:X509IssuerSerial>
            <ns4:X509SubjectName>CN=Praxis Peer Graf von
              MüllerTEST-ONLY,2.5.4.12=#0c0950726f662e2044722e,2.5.4.42=#0c0450656572,2.5.4.4=#0c074dc3bc6c6c6572,O=Praxis
              Peer Graf von MüllerNOT-VALID,STREET=Frohnhauser Straße
              253,2.5.4.17=#0c053435313434,L=Essen,C=DE</ns4:X509SubjectName>
            <ns4:X509Certificate>
              </ns4:X509Certificate>
          </ns4:X509Data>
        </ns4:X509DataInfo>
      </ns4:X509DataInfoList>
...
<S:Envelope xmlns:S="http://schemas.xmlsoap.org/soap/envelope/"
  ...
  <SOAP-ENV:Header />
  <S:Body>
    <ns4:ExternalAuthenticate xmlns:ns4="http://ws.gematik.de/conn/SignatureService/v7.4"
      ...
      <CardHandle>SMC-B-15</CardHandle>
      <ns10:Context>
      ...
      <ns4:OptionalInputs>
        <ns2:SignatureType>urn:bsi:tr:03111:ecdsa</ns2:SignatureType>
      </ns4:OptionalInputs>
      <ns4:BinaryString>
        <ns2:Base64Data MimeType="application/octet-stream">
          EGvRHN8ZHbaFVSaMBoKLVO3CqW6SjWM8fVeIZyClkQw=</ns2:Base64Data>
      </ns4:BinaryString>
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  <SOAP-ENV:Header />
  <SOAP-ENV:Body>
    <ns11:ExternalAuthenticateResponse xmlns:ns11="http://ws.gematik.de/conn/SignatureService/v7.4"
      xmlns:ns10="http://uri.etsi.org/02231/v2#"
      xmlns:ns12="urn:oasis:names:tc:dss-x:1.0:profiles:SignaturePolicy:schema#"
      xmlns:ns2="http://ws.gematik.de/conn/nfds/NFDService/v1.0"
      xmlns:ns3="http://ws.gematik.de/tel/error/v2.0"
      ...
      <ns4:Status>
        <ns4:Result>OK</ns4:Result>
      </ns4:Status>
      <ns6:SignatureObject>
        <ns6:Base64Signature Type="urn:bsi:tr:03111:ecdsa">
          MEQCIGFM9BsPKQYIJA/UgGosqbVh4r84b6OZukGhzXJ4TabwAiBg2dyMpKtXc93ZbcgXz2wP8WWqsdqUumB4jOpd7zXs/A==</ns6:Base64Signature>
      </ns6:SignatureObject>
    </ns11:ExternalAuthenticateResponse>
  </SOAP-ENV:Body>
</SOAP-ENV:Envelope>
----
  ...
  "entry": [
    {
      ...
      "resource": {
        ...
        "meta": {
          "profile": [
            "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Task|1.6"
          ]
        },
        "intent": "order",
        "extension": [
