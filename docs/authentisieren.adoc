...
pOPTFjeEhIVV</m2:X509Certificate> <1>
    </m:VerifyCertificate>
  </SOAP-ENV:Body>
</SOAP-ENV:Envelope>
----
<1> Länge des Soap-Requests, muss entsprechend gesetzt werden.
<2> Das zu prüfende Zertifikat in Base64-DER-Codierung.
|===
    ...
    <SOAP-ENV:Body>
        <ns4:VerifyCertificateResponse
            ...
            <ns4:VerificationStatus>
                <ns4:VerificationResult>VALID</ns4:VerificationResult> <1>
            </ns4:VerificationStatus>
            <ns4:RoleList>
                <ns4:Role>1.2.276.0.76.4.260</ns4:Role> <2>
            </ns4:RoleList>
        </ns4:VerifyCertificateResponse>
    </SOAP-ENV:Body>
</SOAP-ENV:Envelope>
----
<1> Prüfergebnis des Zertifikats [VALID = gültig, INCONCLUSIVE = offline-gültig ohne Sperrstatus, INVALID = ungültig]
<2> Technische Rolle, wie im Zertifikat angegeben.
...
<soap-env:Envelope xmlns:soap-env="http://schemas.xmlsoap.org/soap/envelope/">
  <soap-env:Body>
    <ns0:ExternalAuthenticate xmlns:ns0="http://ws.gematik.de/conn/SignatureService/v7.4">
      ...
      <ns0:BinaryString>
        <ns7:Base64Data xmlns:ns7="urn:oasis:names:tc:dss:1.0:core:schema">3XdaMHV0MaYrvhIwGJhRH12dUUWljb1dbLriSBs2mT8=</ns7:Base64Data> <2>
      </ns0:BinaryString>
...

{
  ...
  "entry": [{
    "fullUrl": "https://erp.zentral.erp.splitdns.ti-dienste.de/Task/588780",    
    "resource": {
      "resourceType": "Task",
      "id":"588780",
      "meta": {
