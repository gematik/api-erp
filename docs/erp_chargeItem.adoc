...
[source,xml]
----
include::resources/prescriptionserver/request_PostChargeItem.xml[]
----
...
[source,xml]
----
include::resources/prescriptionserver/response_PostChargeItem.xml[]
----
...
[source,xml]
----
include::resources/prescriptionserver/response_GetCargeItem.xml[]
----
...
[source,xml]
----
include::resources/prescriptionserver/request_PutChargeItem.xml[]
----
...
[source,xml]
----
include::resources/prescriptionserver/response_PutChargeItem.xml[]
----
...
[source,json]
----
include::resources/prescriptionserver/response_GetChargeItemsVersicherter.json[]
----
...
[source,json]
----
include::resources/prescriptionserver/response_GetChargeItemVersicherterById.json[]
----
NOTE: Das `signature` Element enthält die Signatur des Bundles über alle enthaltenen Objekte als Enveloping-CAdES-Signatur in Base64-Codierung.
...
[source,json]
----
include::resources/prescriptionserver/request_PatchChargeItem.xml[]
----
...
[source,json]
----
include::resources/prescriptionserver/response_PatchChargeItem.json[]
----
