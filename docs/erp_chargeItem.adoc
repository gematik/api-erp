...
<ChargeItem xmlns="http://hl7.org/fhir">
    ...
    <meta>
        <profile value="https://gematik.de/fhir/erpchrg/StructureDefinition/GEM_ERPCHRG_PR_ChargeItem|1.1"/>
    </meta>
    <contained>
        <Binary>
    ...
    <enteredDate value="2025-10-01T15:29:00.434+00:00"/>
    ...
    <entry>
        ...
        <resource>
            <Bundle>
                ...
                <meta>
                    <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Bundle|1.6"/>
                </meta>
                <identifier>
                    <system value="https://gematik.de/fhir/erp/NamingSystem/GEM_ERP_NS_PrescriptionId"/>
                ...
                <entry>
                    ...
                    <resource>
                        <Composition>
                            ...
                            <meta>
                                <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Composition|1.6"/>
                            </meta>
                            ...
                            <event>
                                <period>
                                    <start value="2025-10-01T15:29:00.434+00:00"/>
                                    <end value="2025-10-01T16:29:00.434+00:00"/>
                                </period>
                            </event>
                            <section>
                                <entry>
                ...
                <entry>
                    ...
                    <resource>
                        <Device>
                            <id value="1"/>
                            <meta>
                                <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Device|1.6"/>
                            </meta>
                            <status value="active"/>
                            <serialNumber value="1.18.0"/>
                            <deviceName>
                ...
                <entry>
                    ...
                    <resource>
                        <Binary>
                            ...
                            <meta>
                                <versionId value="1"/>
                                <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Digest|1.6"/>
                            </meta>
                ...
                <signature>
                    ...
                    <when value="2025-10-01T15:29:00.434+00:00"/>
                    <who>
                ...
                <entry>
                    ...
                    <resource>
                        <Composition>
                            ...
                            <date value="2025-10-01T15:29:00+00:00"/>
                            <author>
  ...
  "entry": [
    {
      ...
      "resource": {
        ...
        "meta": {
          "profile": [
            "https://gematik.de/fhir/erpchrg/StructureDefinition/GEM_ERPCHRG_PR_ChargeItem|1.1"
          ]
        },
        "status": "billable",
        "identifier": [
  ...
  "entry": [
    ...
    },
    {
      ...
      "resource": {
        ...
        "meta": {
          "profile": [
            "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Bundle|1.6"
          ]
        },
        "type": "document",
        "identifier": {
        ...
        "entry": [
          {
            ...
            "resource": {
              ...
              "meta": {
                "profile": [
                  "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Composition|1.6"
                ]
              },
              "status": "final",
              "title": "Quittung",
              ...
              "event": [
                {
                  "period": {
                    "start": "2025-10-01T15:29:00.434+00:00",
                    "end": "2025-10-01T16:29:00.434+00:00"
                  }
                }
              ],
              "section": [
          ...
          },
          {
            ...
            "resource": {
              ...
              "meta": {
                "profile": [
                  "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Device|1.6"
                ]
              },
              "status": "active",
              "serialNumber": "1.18.0",
          ...
          },
          {
            ...
            "resource": {
              ...
              "meta": {
                "profile": [
                  "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Digest|1.6"
                ],
                "versionId": "1"
              },
        ...
        "signature": {
          ...
          "when": "2025-10-01T15:29:00.434+00:00",
          "who": {
        ...
        "entry": [
          {
            ...
            "resource": {
              ...
              "date": "2025-10-01T15:29:00+00:00",
              "custodian": {
          ...
          },
          {
            ...
            "resource": {
              ...
              "meta": {
                "profile": [
                  "https://fhir.kbv.de/StructureDefinition/KBV_PR_FOR_Practitioner|1.3"
                ],
                "versionId": "1"
              },
              "name": [
          ...
          },
          {
            ...
            "resource": {
              ...
              "meta": {
                "profile": [
                  "https://fhir.kbv.de/StructureDefinition/KBV_PR_FOR_Organization|1.3"
                ],
                "versionId": "1"
              },
              "telecom": [
          ...
          },
          {
            ...
            "resource": {
              ...
              "meta": {
                "profile": [
                  "https://fhir.kbv.de/StructureDefinition/KBV_PR_FOR_Coverage|1.3"
                ],
                "versionId": "1"
              },
              "status": "active",
    ...
    },
    {
      ...
      "resource": {
        ...
        "meta": {
          "profile": [
            "http://fhir.abda.de/eRezeptAbgabedaten/StructureDefinition/DAV-PKV-PR-ERP-AbgabedatenBundle|1.4"
          ]
        },
        "type": "document",
        "identifier": {
        ...
        "entry": [
          {
            ...
            "resource": {
              ...
              "meta": {
                "profile": [
                  "http://fhir.abda.de/eRezeptAbgabedaten/StructureDefinition/DAV-PKV-PR-ERP-AbgabedatenComposition|1.4"
                ]
              },
              "status": "final",
              "type": {
          ...
          },
          {
            ...
            "resource": {
              ...
              "meta": {
                "profile": [
                  "http://fhir.abda.de/eRezeptAbgabedaten/StructureDefinition/DAV-PKV-PR-ERP-Apotheke|1.4"
                ]
              },
              "identifier": [
                {
          ...
          },
          {
            ...
            "resource": {
              ...
              "meta": {
                "profile": [
                  "http://fhir.abda.de/eRezeptAbgabedaten/StructureDefinition/DAV-PKV-PR-ERP-Abgabeinformationen|1.4"
                ]
              },
              "status": "completed",
              "medicationCodeableConcept": {
          ...
          },
          {
            ...
            "resource": {
              ...
              "meta": {
                "profile": [
                  "http://fhir.abda.de/eRezeptAbgabedaten/StructureDefinition/DAV-PKV-PR-ERP-Abrechnungszeilen|1.4"
                ]
              },
              "status": "issued",
              "type": {
...
----
{
  ...
  "meta": {
    "profile": [
      "https://gematik.de/fhir/erpchrg/StructureDefinition/GEM_ERPCHRG_PR_PAR_Patch_ChargeItem_Input|1.1"
    ]
  },
  "parameter": [
    {
