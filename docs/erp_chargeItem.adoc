...
<ChargeItem xmlns="http://hl7.org/fhir">
    ...
    <contained>
        <Binary>
            <id value="ChargeItem-Abgabedaten-Binary"/>
    ...
    <supportingInformation>
        <reference value="#ChargeItem-Abgabedaten-Binary"/>
...
<ChargeItem xmlns="http://hl7.org/fhir">
    ...
    <enteredDate value="2025-10-01T15:29:00.434+00:00"/>
    <supportingInformation>
        <reference value="urn:uuid:ChargeItem-KBV-Bundle"/>
        <display value="https://fhir.kbv.de/StructureDefinition/KBV_PR_ERP_Bundle"/>
    </supportingInformation>
    <supportingInformation>
        <reference value="urn:uuid:ChargeItem-Receipt-Bundle"/>
        <display value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Bundle"/>
    </supportingInformation>
    <supportingInformation>
        <reference value="urn:uuid:ChargeItem-Abgabedaten-Bundle"/>
...
<Bundle xmlns="http://hl7.org/fhir">
    ...
    <entry>
        <fullUrl value="urn:uuid:ChargeItem-Receipt-Bundle"/>
        <resource>
            <Bundle>
                <id value="ChargeItem-Receipt-Bundle"/>
                <meta>
    ...
    <entry>
        <fullUrl value="urn:uuid:ChargeItem-KBV-Bundle"/>
        <resource>
            <Bundle>
                <id value="ChargeItem-KBV-Bundle"/>
                <meta>
    ...
    <entry>
        <fullUrl value="urn:uuid:ChargeItem-Abgabedaten-Bundle"/>
        <resource>
            <Bundle>
  ...
  "entry": [
    {
      ...
      "resource": {
        ...
        "supportingInformation": [
          {
            "display": "https://fhir.kbv.de/StructureDefinition/KBV_PR_ERP_Bundle",
            "reference": "urn:uuid:ChargeItem-PKV-KBV-Bundle"
          },
          {
            "display": "http://fhir.abda.de/eRezeptAbgabedaten/StructureDefinition/DAV-PKV-PR-ERP-AbgabedatenBundle",
            "reference": "urn:uuid:ChargeItem-PKV-Abgabedaten-Bundle"
          },
          {
            "display": "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Bundle",
            "reference": "urn:uuid:ChargeItem-Receipt-Bundle"
    ...
    {
      "fullUrl": "urn:uuid:ChargeItem-Receipt-Bundle",
      "resource": {
        "resourceType": "Bundle",
        "id": "ChargeItem-Receipt-Bundle",
        "meta": {
          "profile": [
    ...
    {
      "fullUrl": "urn:uuid:ChargeItem-PKV-KBV-Bundle",
      "resource": {
        "resourceType": "Bundle",
        "id": "ChargeItem-PKV-KBV-Bundle",
        "meta": {
          "profile": [
    ...
    {
      "fullUrl": "urn:uuid:ChargeItem-PKV-Abgabedaten-Bundle",
      "resource": {
        "resourceType": "Bundle",
