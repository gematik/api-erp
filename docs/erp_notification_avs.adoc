...
<Subscription>
  ...
  <criteria value="Communication?received=null&amp;recipient=3-abc-12345678"/> <1>
  <channel>
...
|===
<1> Das Feld `criteria` benennt die Suchparameter, bei denen eine Notification verschickt werden soll. Das sind zum einen `received=null` für ungelesene Nachrichten und `recipient=3-abc-12345678` die Telematik-ID der Apotheke, die mit der Telematik-ID des IDP-AccessToken übereinstimmen muss.
...
Content-Length: 510
Content-Type: application/fhir+xml;charset=utf-8
Location: https://erp.zentral.erp.splitdns.ti-dienste.de/Subscription/838dabe4e05416c776d60256c511558f6831f679c613f203d30b58b05555618a

<Subscription>
  <id value="838dabe4e05416c776d60256c511558f6831f679c613f203d30b58b05555618a"/> <1>
  <status value="active"/>
  <end value="2022-01-01T00:00:00Z"/> <2>
...
{
   "resourceType": "Subscription",
   "id": "838dabe4e05416c776d60256c511558f6831f679c613f203d30b58b05555618a",
   "status": "active“,
   "end": "2022-01-01T00:00:00Z", 
   "criteria": "Communication?received=null&recipient=recipient=3-abc-12345678",
   "channel": {
     "type": "websocket", 
...
<1> Eindeutige ID (Pseudonym der Telematik-ID)
<2> timestamp = jetzt + 12h
<3> die Header müssen beim Web Socket Upgrade mitgegeben werden
...
Sec-WebSocket-Key: q4xkcO32u266gldTuKaSOw== <2>
----

TIP: Dieser Request ist NICHT zusätzlich VAU-verschlüsselt, sondern wird plain an den Subscription-Endpunkt geschickt.

|===
<1> Hier wird das von der VAU generierte Bearer Token mit dem Pseudonym über die Telematik-ID übergeben.
<2> clientseitig generierte Nonce (16-Byte Zufallswert in base64-Codierung), siehe link:https://www.rfc-editor.org/rfc/rfc6455#page-18[RFC-6455 Seite 18, Punkt 7]
...
----
<1> Der Subscription-Service antwortet mit einem Upgrade
...
[source,html]
----
bind: 838dabe4e05416c776d60256c511558f6831f679c613f203d30b58b05555618a <1>
----
<1> `Subscription.id`
...
[source,html]
----
bound: 838dabe4e05416c776d60256c511558f6831f679c613f203d30b58b05555618a <1>
----
<1> `Subscription.id`
...
[source,html]
----
ping: 838dabe4e05416c776d60256c511558f6831f679c613f203d30b58b05555618a <1>
----
<1> `Subscription.id`

WARNING: Hinweis: die Nachricht `ping: 838dabe4e05416c776d60256c511558f6831f679c613f203d30b58b05555618a` ist *KEIN* `Ping` der Ping/Pong Control Frames für das Aufrechterhalten der Verbindung (siehe https://datatracker.ietf.org/doc/html/rfc6455#section-5.5).

Empfängt das AVS nun ein `ping: 838dabe4e05416c776d60256c511558f6831f679c613f203d30b58b05555618a`, liegt eine neue Nachricht vor, die über das VAU-Protokoll zum link:erp_communication.adoc#user-content-anwendungsfall-auf-neue-nachrichten-im-e-rezept-fachdienst-prüfen[Abrufen neuer Nachrichten] heruntergeladen werden kann. Über die Websockets werden selbst keine Nachrichten oder andere E-Rezept-bezogenen Daten verschickt.
