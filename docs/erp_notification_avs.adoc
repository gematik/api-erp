...
Content-Length: 510
Content-Type: application/fhir+xml;charset=utf-8
Location: https://erp.zentral.erp.splitdns.ti-dienste.de/Subscription/df694c098c2fb373524150461cfd9d23

<Subscription>
  <id value="df694c098c2fb373524150461cfd9d23"/> <1>
  <status value="active"/>
...
<2> timestamp = jetzt + 12h (UTC Timestamp) +
...
[source,html]
----
bind: df694c098c2fb373524150461cfd9d23 <1>
----
<1> `Subscription.id`
...
[source,html]
----
bound: df694c098c2fb373524150461cfd9d23 <1>
----
<1> `Subscription.id`
...
[source,html]
----
ping: df694c098c2fb373524150461cfd9d23 <1>
----
<1> `Subscription.id`
