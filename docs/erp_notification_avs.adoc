...
[source,xml]
----
include::resources/vau/request_PostSubscriptionPseudo.xml[]
----
...
[source,xml]
----
include::resources/vau/response_PostSubscriptionPseudo.xml[]
----
...
[source,c++]
----
include::resources/vau/ping_Subscription.cpp[]
----
