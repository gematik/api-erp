...
Content-Location: https://erp.app.ti-dienste.de/Bundle/f5ba6eaf-9052-42f6-ac4e-fadceed7293b

{
  ...
  "entry": [{
    "fullUrl": "https://erp.app.ti-dienste.de/Task/588780",
    "resource": {
      "resourceType":"Task",
      "id":"588780",
      "meta":{
...
[%autowidth]
|===
|URI        |https://erp.app.ti-dienste.de/Task/4711
|Method     |GET
|HTTP Header |
----
Authorization: Bearer eyJraWQ.ewogImL2pA10Qql22ddtutrvx4FsDlz.rHQjEmB1lLmpqn9J <1> 
...
Content-Type: application/fhir+json;charset=utf-8 
Content-Location: 
  https://erp.app.ti-dienste.de/Task/4711
{
  "resourceType": "Bundle",
  "id": "f5ba6eaf-9052-42f6-ac4e-fadceed7293b",
  "meta": {
  ...
  "link": [{
    "relation": "self",
    "url": "https://erp.app.ti-dienste.de/Task/4711"
  }],
  "entry": [{
    "fullUrl": "https://erp.app.ti-dienste.de/Task/4711",
    "resource": {
      "resourceType":"Task",
      "id":"4711",
      "meta":{
...
... <6>
      ...
      "signature": { <7>
        ...
        "when": "2020-03-20T07:31:34.328+00:00",
        "who": "https://erp.app.splitdns.ti-dienste.de/signature/verification",
        "data": "eyJ0eXAiOiJKV1MiLCJhbGciOiJFUzI1NiIsIng1dSI6Imh0dHBzOi8vcHJlc2NyaXB0aW9uc2VydmVyLnRlbGVtYXRpay9zaWduYXR1cmUvY2VydGlmaWNhdGUifQ
        .
...
* Adresse des Tasks unter dem das E-Rezept geführt wird: `https://erp.app.ti-dienste.de/Task/4711`
...
* Suche nach einer Apotheke mit konkretem Namen "Apotheke um die Ecke" +
  `https://apovzd.app.ti-dienste.de/Organization?type=urn:oid|1.2.276.0.76.4.32&name=Apotheke%20um%20die%20Ecke`
* Suche nach allen Apotheken in "Berlin" +
  `https://apovzd.app.ti-dienste.de/Organization?type=urn:oid|1.2.276.0.76.4.32&address-city=Berlin` 
...
[%autowidth]
|===
|URI        |https://apovzd.app.ti-dienste.de/Organization?type=urn:oid\|1.2.276.0.76.4.32&address-postalcode=10117 <1> +
...

{
  ...
  "link": [ {
    "relation": "self",
    "url": "http://apovzd.app.ti-dienste.de/Organization?type=urn:oid|1.2.276.0.76.4.32&address-postalcode=10117"
  } ],
  "entry": [ {
    "fullUrl": "http://apovzd.app.ti-dienste.de/Organization/100219",
    "resource": {
    ...
    "fullUrl": "http://apovzd.app.ti-dienste.de/Organization/100218",
    "resource": {
      "resourceType": "Organization",
      "id": "100218",
      "meta": {
...
[%autowidth]
|===
|URI        |https://erp.app.ti-dienste.de/MedicationDispense?whenhandedover=gt2020-03-01 <1>  +
...
[%autowidth]
|===
|URI        |https://erp.app.ti-dienste.de/Task/4711/$abort
|Method     |POST
|HTTP Header |
----
Authorization: Bearer eyJraWQ.ewogImL2pA10Qql22ddtutrvx4FsDlz.rHQjEmB1lLmpqn9J <1>
...

{
  ...
  "link": [ {
    ...
    "relation": "next",
    "url": "https://erp.app.ti-dienste.de/AuditEvent?_getpages=12653b13-5fca-4e3b-860c-9558bdfef9a1&_getpagesoffset=20&_count=20" <2>
  } ],
  "entry": [ {
    "fullUrl": "https://erp.app.ti-dienste.de/AuditEvent/58862", <3>
    "resource": {
      ...
      "entity": [ {
        "what": {
          "reference": "https://erp.app.ti-dienste.de/Task/4711",
          "identifier": {
            "use":"official",
            "system":"https://gematik.de/fhir/NamingSystem/PrescriptionID",
            "value":"160.123.456.789.123.58"
