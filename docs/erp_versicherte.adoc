...
----
^.^| image:qr_sample.png[width=250px]

In QR-Code-Darstellung gemäß ISO/IEC 18004:2006
|================
NOTE: Aktuell unterstützen die Apothekenverwaltungssysteme auf Basis des SecurPharm-Systems in jedem Fall das DataMatrix-Format. 
