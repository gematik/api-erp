= image:../../images/gematik_logo.jpg[width=35%] E-Rezept API Dokumentation für Versicherte
...
Task: https://simplifier.net/e-rezept/erxtask
AuditEvent: https://simplifier.net/e-rezept/erxauditevent
...
|================
.2+^.<| image:../../images/fdv.png[width=100%] 
...
^.^| image:../../images/datamatrix_sample.png[width=250px] 

In DataMatrix-Darstellung gemäß ISO/IEC 16022:2006
| Sammlung von drei E-Rezept-Referenzen in einem 2D-Code +
`[{Task/4711/$accept?ac=777bea0e13cc9c42ceec14aec3ddee2263325dc2c6c699db115f58fe423607ea},
  {Task/4712/$accept?ac=d1b8fdaa9e1be1b14a6302457468136923ecbfc7c48f88af5997f4271b736d1b},
  {Task/4713/$accept?ac=2a38b04e400ec97183bd00b98bb74fd73c9d2afa2a54f6f841e527ecb0df3e0c}]`

^.^| image:../../images/datamatrix_sample_3.png[width=250px] 

In DataMatrix-Darstellung gemäß ISO/IEC 16022:2006
| 
`Task/4711/$accept?ac=777bea0e13cc9c42ceec14aec3ddee2263325dc2c6c699db115f58fe423607ea`
^.^| image:../../images/qr_sample.png[width=250px]
...
3.+| Der Aufruf erfolgt als http-`GET`-Operation am Verzeichnisdienst der Telematikinfrastruktur für die Ressource `/Organization`. Im Aufruf muss das während der Authentisierung erhaltene ID_TOKEN im http-Request-Header `Authorization` für eine Rollenprpfung übergeben werden. Der Verzreichnisdienst liefert eine Liste von Apotheken, welche den ggfs. angegebenen Suchparametern entsprechen. Liefert die gewählte Suchanfrage eine zu große Ergebnismenge, bricht der Verzeichnisdienst bei eiener technischen Obergrenze von max. `100` Ergebniseinträgen ab.
s|Code   2+s|Type Success  
|200  2+| OK +
...
3.+| Der Aufruf erfolgt als http-`GET`-Operation auf die Ressource `/AuditEvent`. Im Aufruf muss das während der Authentisierung erhaltene ID_TOKEN im http-Request-Header `Authorization` übergeben werden, der Fachdienst filtert die AuditEvent-Einträge nach der im ID_TOKEN enthaltenen KVNR des Versicherten.
