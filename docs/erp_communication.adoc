...
----
<1> Die Apotheke antwortet mit den angebotenen Belieferungsoptionen, die wie hier dargestellt von den angefragten Optionen bei `shipment` abweichen, d.h. die Apotheke bietet zusätzlich an, das Medikament per Post zu liefern. 
