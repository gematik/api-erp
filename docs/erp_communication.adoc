...
----
{
  ...
  "payload": [
    {
      "contentString": "{ \"transactionID\": \"ABCD-EFGH-IJKL-MNOP\", \"version\": 3, \"communicationType\": \"order\", \"supplyOptionsType\": \"onPremise\", \"phone\": \"004916094858168\" }"
    }
  ]
}
----
...
<Communication xmlns="http://hl7.org/fhir">
	<id value="erp-communication-03-request-PostPharmacyToPatient" />
	<meta>
		<profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Communication_Reply|1.6" />
	</meta>
	<basedOn>
		<reference value="Task/160.000.000.000.000.01" />
	</basedOn>
	...
	<payload>
		<contentString value="{&quot;version&quot;: 3, &quot;communicationType&quot;: &quot;pickupCodeHR&quot;, &quot;text&quot;: &quot;Wir möchten Sie informieren, dass Ihre bestellten Medikamente zur Abholung bereitstehen. Den Abholcode finden Sie anbei.&quot;, &quot;pickupCodeHR&quot;: &quot;12341234&quot;, &quot;transactionID&quot;: &quot;ABCD-EFGH-IJKL-MNOP&quot;}" />
	</payload>
</Communication>
----
NOTE: Die von der Apotheke übermittelte Antwort ist strukturiert in .payload.contentString nach gemSpec_eRp_DM abgelegt.
...
{
  "resourceType": "Communication",
  "id": "erp-communication-09-request-MessagePharmacy",
  "meta": {
    "profile": [
      "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Communication_DispReq|1.6"
    ]
  ...
  "payload": [
    {
      "contentString": "{ \"transactionID\": \"ABCD-EFGH-IJKL-MNOP\", \"version\": 3, \"communicationType\": \"text\", \"text\": \"Gibt es noch Traubenzucker?\", \"phone\": \"004916094858168\" }"
    }
  ]
}
----
