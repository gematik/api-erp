...
<Bundle xmlns="http://hl7.org/fhir">
    <id value="erp-abrufen-01-response-taskAccept"/>
    <type value="collection"/>
    <timestamp value="2025-10-01T15:29:00.434+00:00"/>
    <link>
        <relation value="self"/>
        <url value="https://erp-ref.zentral.erp.splitdns.ti-dienste.de/Task/160.000.000.000.000.01/$accept/"/>
    </link>
    <entry>
        ...
        <resource>
            <Task>
                ...
                <input>
                    ...
                    <valueReference>
                        <reference value="Binary/281a985c-f25b-4aae-91a6-41ad744080b0"/>
                    </valueReference>
                </input>
            </Task>
        </resource>
    ...
    <entry>
        ...
        <resource>
            <Binary>
                <id value="Inline-Instance-for-dffbfd6a-5712-4798-bdc8-07201eb77ab8-2"/>
                <meta>
                    <versionId value="1"/>
                    <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Binary|1.6"/>
                </meta>
...
----
<Bundle xmlns="http://hl7.org/fhir">
    <id value="erp-abrufen-02-response-taskAcceptWithConsent"/>
    <type value="collection"/>
    <timestamp value="2025-10-01T15:29:00.434+00:00"/>
    <link>
        <relation value="self"/>
        <url value="https://erp-dev.zentral.erp.splitdns.ti-dienste.de/Task/200.000.000.000.000.01/$accept/"/>
    </link>
    <entry>
        <fullUrl value="https://erp-dev.zentral.erp.splitdns.ti-dienste.de/Task/200.000.000.000.000.01"/>
        <resource>
            <Task>
                ...
                <input>
                    ...
                    <valueReference>
                        <reference value="Binary/c89c8312-0000-0000-0001-000000000000"/>
                    </valueReference>
                </input>
            </Task>
        </resource>
    ...
    <entry>
        ...
        <resource>
            <Binary>
                <id value="c89c8312-0000-0000-0001-000000000000"/>
                <meta>
                    <versionId value="1"/>
                    <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Binary|1.6"/>
                </meta>
    ...
    <entry>
        <fullUrl value="https://erp-dev.zentral.erp.splitdns.ti-dienste.de/Consent/CHARGCONS-P987654321"/>
        <resource>
            <Consent>
                <id value="CHARGCONS-P987654321"/>
                <meta>
                    <profile value="https://gematik.de/fhir/erpchrg/StructureDefinition/GEM_ERPCHRG_PR_Consent|1.1"/>
                </meta>
                <status value="active"/>
                <scope>
                    <coding>
                ...
                <dateTime value="2025-10-01T15:29:00+00:00"/>
                <policyRule>
                    <coding>
...
----
<Bundle xmlns="http://hl7.org/fhir">
    <id value="erp-abrufen-03-request-recovery-secret"/>
    <type value="collection"/>
    <timestamp value="2025-10-01T15:29:00.434+00:00"/>
    <link>
        <relation value="self"/>
        <url value="https://erp-ref.zentral.erp.splitdns.ti-dienste.de/Task/160.000.000.000.000.01"/>
    </link>
    <entry>
        <fullUrl value="https://erp-ref.zentral.erp.splitdns.ti-dienste.de/Task/160.000.000.000.000.01"/>
        <resource>
            <Task>
                <id value="160.000.000.000.000.01"/>
                <meta>
...
<Parameters xmlns="http://hl7.org/fhir">
    <id value="erp-abrufen-06-request-taskDispense"/>
    <meta>
        <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_PAR_DispenseOperation_Input|1.6"/>
    </meta>
    <parameter>
        ...
        <part>
            ...
            <resource>
                <MedicationDispense>
                    <id value="erp-abrufen-06-request-taskDispense-medicationDispense"/>
                    <meta>
                        <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_MedicationDispense|1.6"/>
                    </meta>
                    <extension url="http://hl7.org/fhir/5.0/StructureDefinition/extension-MedicationDispense.renderedDosageInstruction">
                        <valueMarkdown value="1-0-1-0"/>
                    </extension>
                    <extension url="http://ig.fhir.de/igs/medication/StructureDefinition/GeneratedDosageInstructionsMeta">
        ...
        <part>
            ...
            <resource>
                <Medication>
                    ...
                    <meta>
                        <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Medication|1.6"/>
                    </meta>
...
----
<Parameters xmlns="http://hl7.org/fhir">
    <id value="erp-abrufen-07-request-taskCloseMultiple"/>
    <meta>
        <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_PAR_CloseOperation_Input|1.6"/>
    </meta>
    <parameter>
        <name value="rxDispensation"/>
        <part>
        ...
        <part>
            ...
            <resource>
                <MedicationDispense>
                    ...
                    <status value="completed"/>
                    <medicationReference>
                        <reference value="Medication/FlusarionMedication"/>
                    </medicationReference>
                    <subject>
                        <identifier>
                            <system value="http://fhir.de/sid/gkv/kvid-10"/>
...
----
<Parameters xmlns="http://hl7.org/fhir">
    <id value="erp-abrufen-06-request-taskClose"/>
    <meta>
        <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_PAR_CloseOperation_Input|1.6"/>
    </meta>
    <parameter>
        ...
        <part>
            ...
            <resource>
                <MedicationDispense>
                    <id value="erp-abrufen-06-request-taskClose-medicationDispense"/>
                    <meta>
                        <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_MedicationDispense|1.6"/>
                    </meta>
                    <extension url="http://hl7.org/fhir/5.0/StructureDefinition/extension-MedicationDispense.renderedDosageInstruction">
...
----
<Bundle xmlns="http://hl7.org/fhir">
    <id value="erp-abrufen-09-response-taskClose"/>
    <meta>
...
Die in diesem Aufruf beschriebene Response wird zurückgegeben, wenn der Task den Status `completed` hat. Wenn der Status des Tasks auf `in-progress` gesetzt ist, wird bei diesem Abruf der Task ohne Quittung zurückgegeben.
...
<Bundle xmlns="http://hl7.org/fhir">
        ...
        <resource>
            <Task>
                ...
                <extension url="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_EX_LastMedicationDispense">
                    <valueInstant value="2025-10-01T16:29:00.434+00:00"/>
                </extension>
                <identifier>
                    <use value="official"/>
                    <system value="https://gematik.de/fhir/erp/NamingSystem/GEM_ERP_NS_PrescriptionId"/>
                ...
                <input>
                    ...
                    <valueReference>
                        <reference value="a562d322-8b4f-449c-a88f-57ed2a8b96f7"/>
                    </valueReference>
                </input>
            </Task>
        </resource>
    ...
    <entry>
        <fullUrl value="urn:uuid:a562d322-8b4f-449c-a88f-57ed2a8b96f7"/>
        <resource>
            <Bundle>
                <id value="a562d322-8b4f-449c-a88f-57ed2a8b96f7"/>
                <meta>
                    <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Bundle|1.6"/>
                </meta>
                <identifier>
...
image:datamatrix_sample_4.png[width=230px]
