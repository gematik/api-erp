...
<MedicationDispense xmlns="http://hl7.org/fhir">  <1>
  ...
  <contained> 
    <Medication> <2>
      <id value="med0314"/> 
      <meta>
        <profile value="https://fhir.kbv.de/StructureDefinition/KBV_PR_ERP_Medikament_PZN\|1.0.1" />
      </meta>
