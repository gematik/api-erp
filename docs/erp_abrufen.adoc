    ...
    <entry>
        ...
        <resource>
            <Consent>
                ...
                <dateTime value="2025-01-15T15:29:00+00:00"/>
                <policyRule>
                    <coding>
...
NOTE: Nach Abstimmungen mit der AVS-Industrie, wurde vereinbart, dass zum Start der ePA 3.0 die Angabe von Dosierinformationen als Freitext unter MedicationDispense.dosageInstruction dann zu erfolgen hat, wenn die Dosierinformation von denen der Verordnung abweicht.
**Eine strukturierte Angabe der Dosierinformationen ist nicht erlaubt!** Wichtige Hinweise zum Lesen der Informationen aus der eML finden sich auf einer link:https://service.gematik.de/servicedesk/customer/kb/view/611625958[entsprechenden Informationsseite].
