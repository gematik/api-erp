...
**Eine strukturierte Angabe der Dosierinformationen ist nicht erlaubt!** Informationen dazu finden sich auf einer link:https://service.gematik.de/servicedesk/customer/kb/view/611625958[entsprechenden Informationsseite].
