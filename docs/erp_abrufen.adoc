= image:../../images/gematik_logo.jpg[width=35%] E-Rezept API Dokumentation für Apotheker
...
image:../../images/api_rezept_abrufen.png[width=100%]
      ...
      <Bundle xmlns="http://hl7.org/fhir">
        ...
        <signature>
          ...
          <data>
           ...
           ANFRAGE AN GKV ZUM GEWÜNSCHTEN SIGNATURFORMAT GESTELLT
