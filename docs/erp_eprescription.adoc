  ...
  <parameter>
    ...
    <resource>
      <Practitioner>
        ...
        <identifier>
          <system value="http://local-identifier.esp/practitioner-id"/>
  ...
  <parameter>
    ...
    <resource>
      <Organization>
        ...
        <identifier>
          <system value="http://local-identifier.esp/pharmacia-id"/>
          <value value="1234567890"/>
        </identifier>
        <identifier>
          <system value="http://eu-unified-identifier.eu/pharmacy"/>
