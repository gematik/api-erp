...
----
{
  ...
  "meta": {
    "profile": [
      "https://gematik.de/fhir/erp/GEM_ERP_PR_PAR_PATCH_Task_Input|1.0"
    ]
  },
  "parameter": [
    {
...
----
====
FHIR-Profil: link:https://gematik.de/fhir/erp-eu/StructureDefinition/GEM_ERPEU_PR_PAR_PATCH_Prescription_Input[GEM_ERPEU_PR_PAR_PATCH_Prescription_Input]
...
----
====
FHIR-Profil: link:https://gematik.de/fhir/erp-eu/StructureDefinition/GEM_ERP_PR_Task[GEM_ERP_PR_Task]
