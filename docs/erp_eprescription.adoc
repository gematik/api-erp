...
*X-ncpeh-healthcare-facility-type*: <Healthcare Facility Type gemäß eHealth DSI Code List in Form der deutschen Bezeichnung. >
*_count*: <Anzahl der zurückzugebenden Einträge. Für `demographics` Use Case auf `1` gesetzt.>
*id*: <Liste der Rezept-IDs, die abgefragt werden sollen. Für `e-prescriptions-retrieval` Use Case verwendet>
    ...
    <parameter>
        ...
        <resource>
            <Practitioner>
                ...
                <meta>
                    <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_EUPractitioner|1.5"/>
                </meta>
                <identifier>
    ...
    <parameter>
        ...
        <resource>
            <Organization>
                ...
                <meta>
                    <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_EUOrganization|1.5"/>
                </meta>
                <identifier>
    ...
    <parameter>
        ...
        <resource>
            <PractitionerRole>
                ...
                <meta>
                    <profile value="https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_EUPractitionerRole|1.5"/>
                </meta>
                <practitioner>
