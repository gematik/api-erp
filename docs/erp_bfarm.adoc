        ...
        },
        {
          ...
          "resource": {
            ...
            "subject": {
              ...
              "display": "DataAbsentReason-Extension: #not-permitted, dieser Wert wird leer gelassen"
            },
            "dosageInstruction": [
              {
                "extension": [
                  {
                    "valueCoding": {
                      "system": "https://fhir.kbv.de/CodeSystem/KBV_CS_ERP_Dosage_Category",
                      "code": "DAILY_FOUR_SCHEME"
                    },
      ...
      "part": [
        {
          ...
          "resource": {
            ...
            "id": "TRP-Carbon-Copy-Organization",
            "telecom": [
              {
                "system": "phone",
                "value": "1234",
        ...
        },
        {
          ...
          "resource": {
            ...
            "performer": [
              {
                "actor": {
                  "reference": "Organization/3-SMC-B-Testkarte-883110000095957"
                }
              }
            ],
            "status": "completed",
