...
<Task xmlns="http://hl7.org/fhir">
    <id value="erp-diga-01-task-162-create"/>
...
----
{
  ...
  "id": "162.000.000.000.000.01-5",
  "meta": {
    "profile": [
      "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_MedicationDispense_DiGA|1.4"
    ],
    "id": "MedicationDispense-erp-diga-04-medication-dispense-diga"
  },
  "identifier": [
    {
...
<Bundle xmlns="http://hl7.org/fhir">
    ...
    <link>
        <relation value="self"/>
        <url value="https://erp-ref.zentral.erp.splitdns.ti-dienste.de/Task/162.123.456.789.123.58/$accept/"/>
    </link>
    <entry>
...
[source,xml]
----
Unresolved directive in erp_diga-source.adoc - include::https://raw.githubusercontent.com/gematik/eRezept-Examples/feature/api-examples-wf-1.4.2/API-Examples/2025-01-15/erp_diga/06_medication_dispense_diga.xml[]
----
