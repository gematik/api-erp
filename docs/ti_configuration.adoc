...
==== Problemstellung
Der VSDM++-Abruf für das Feature „eGK in der Apotheke“ führt in einigen Fällen zu einem Timeout. Dies äußert sich dadurch, dass der Abruf etwa 25 Sekunden dauert und mit einem Prüfnachweis mit dem Code „3“ quittiert wird.
