...
ECC
* PU: https://download.tsl.ti-dienste.de/ECC/
* RU: https://download-ref.tsl.ti-dienste.de/ECC/
* TU: https://download-test.tsl.ti-dienste.de/ECC/
...
* `ROOT-CA` -> `GEM.RCA6.der`
* `SUB-CA` -> `GEM.KOMP-CA7.der`
...
und
* `ROOT-CA` -> `GEM.RCA8_TEST-ONLY.der`
* `SUB-CA` -> `GEM.KOMP-CA56_TEST-ONLY.der`

ECC (PU):

* `ROOT-CA` -> `GEM.RCA4.der`
* `SUB-CA` -> `GEM.KOMP-CA6.der`
und
* `ROOT-CA` -> `GEM.RCA8.der`
* `SUB-CA` -> `GEM.KOMP-CA9.der`
