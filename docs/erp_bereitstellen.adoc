...
CAUTION: DEPRECATED KBV-Bundle, zulässig bis 30.06.2023. Aus konsistenzgründen wird dies hier genutzt.
    ...
    <entry>
        ...
        <resource>
            <MedicationRequest xmlns="http://hl7.org/fhir">
                ...
                <note>
                    <text value="Dummy-Hinweis f�r die Apotheke" />
                </note>
                <dosageInstruction>
    ...
    <entry>
        ...
        <resource>
            <Practitioner xmlns="http://hl7.org/fhir">
                ...
                <name>
                    <use value="official" />
                    <family value="Topp-Gl�cklich">
                        <extension url="http://hl7.org/fhir/StructureDefinition/humanname-own-name">
                            <valueString value="Topp-Gl�cklich" />
                        </extension>
                    </family>
                    <given value="Hans" />
                    <prefix value="Dr. med.">
    ...
    <entry>
        ...
        <resource>
            <Organization xmlns="http://hl7.org/fhir">
                ...
                <name value="Hausarztpraxis Dr. Topp-Gl�cklich" />
                <telecom>
                    <system value="phone" />
