...
[source,xml]
----
Unresolved directive in erp_bereitstellen-source.adoc - include::https://raw.githubusercontent.com/gematik/eRezept-Examples/feature/api-examples-wf-1.4.2/API-Examples/2025-01-15/erp_bereitstellen/02_Prescription_bundle.xml[]
----
====
