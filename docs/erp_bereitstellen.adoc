...
link:https://github.com/gematik/eRezept-Examples/{branch}/API-Examples/{date-folder}/erp_bereitstellen/03_request_SignDocument.xml[Link zum Beispiel]
...
<Task xmlns="http://hl7.org/fhir">
    <id value="160.000.000.000.000.01-01"/>
