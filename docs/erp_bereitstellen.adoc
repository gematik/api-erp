ifdef::env-github[]
:imagesdir: https://github.com/gematik/api-erp/tree/master/images
endif::[]
= image:../../images/gematik_logo.jpg[width=35%] E-Rezept API-Dokumentation für Ärzte/Zahnärzte
...
image:../../images/api_rezept_einstellen.png[width=100%]
