...
== 2024.10.01
Ein Update der Workflow Profile, wonach insbesondere das Feature "Zeitnahe Dokumentation der Abgabe" durch die FHIR-Profile verfügbar gemacht wird.
...
* Hinzufügen von Task.extension:lastMedicationDispense
...
* MedicationDispense.whenHandedOver und .whenPrepared müssen dem Format YYYY-MM-DD entsprechen
