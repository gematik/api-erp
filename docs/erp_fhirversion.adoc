...
|gematik de.gematik.erezept-workflow.r4 |link:https://simplifier.net/packages/de.gematik.erezept-workflow.r4/1.4.0-rc1[Pre-release Package 1.4.0-rc1 Profile 1.4^] a|

Prerelease ePA/eML und DiGA
...
link:./erp_fhirversion_change_20241101.adoc[Weitere Details zu den Änderungen am E-Rezept-Fachdienst im Zusammenhang mit den FHIR-Profilen sind hier zu finden.]
