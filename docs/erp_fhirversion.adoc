...
* Feature Zeitnahe Bereitstellung der Abgabedaten
...
NOTE: Das Gültigkeitsdatum wird noch festgelegt und ist nach aktuellem Stand der 15.01.2025.

[cols="h,a,40%,a,a,a"]
|===
|        |*Versionsnummer* |*Releasenotes* |*Datum Veröffentlichung* |*Datum gültig ab* |*Datum gültig bis*

|gematik de.gematik.erezept-workflow.r4 |link:https://simplifier.net/packages/de.gematik.erezept-workflow.r4/1.3.0-rc2[Package 1.3.0-rc2 Profile 1.3^] a|

* Neue meta.profile Strings (**Breaking Change**)
...
* MedicationDispense.whenHandedOver und müssen dem Format YYYY-MM-DD entsprechen
* Allgemeine Verbesserungen der Beschreibungen
* Neuer Workflow Type (162) für DiGA-Verordnungen
* Anpassungen der MedicationDispense für DiGA-Verordnungen
* Slicing discriminator angepasst im QuittungsBundle #profile zu #type

|01.07.2024 |15.01.2025 |-
...
== 2024.11.01
Es erfolgt ein Update der Abgabedaten des DAV und den Abrechnungsdaten von GKV-SV

NOTE: Das Gültigkeitsdatum wird noch festgelegt und ist nach aktuellem Stand der 01.11.2024.

[cols="h,a,40%,a,a,a"]
|===
|        |*Versionsnummer* |*Releasenotes* |*Datum Veröffentlichung* |*Datum gültig ab* |*Datum gültig bis*

|DAV de.abda.eRezeptAbgabedatenBasis |link:https://simplifier.net/packages/de.abda.erezeptabgabedatenbasis/1.4.0-rc[Package 1.4.0-rc Profile 1.4^] a|
...
|DAV de.abda.eRezeptAbgabedaten |link:https://simplifier.net/packages/de.abda.erezeptabgabedatenbasis/1.4.0-rc2[Package 1.4.0-rc2 Profile 1.4^] a|
...
|GKV-SV de.gkvsv.eRezeptAbrechnungsdaten |link:https://simplifier.net/packages/de.gkvsv.eRezeptAbrechnungsdaten/1.4.0-rc[Package 1.4.0-rc Profile 1.4^] a|
