...
link:https://simplifier.net/packages/de.abda.erezeptabgabedatenbasis/1.4.1[Release Notes]
...
link:https://simplifier.net/packages/de.abda.erezeptabgabedaten/1.4.1[Release Notes]
...
link:https://simplifier.net/packages/de.gkvsv.eRezeptAbrechnungsdaten/1.4.0[Release Notes]

|01.05.2024 |ab Abrechnungsmonat 11/2024 |-
...
link:https://simplifier.net/packages/de.gematik.erezept-workflow.r4/1.3.1[Release Notes]
...
link:https://simplifier.net/packages/de.gematik.erezept-patientenrechnung.r4/1.0.3[Release Notes]
 ...
 ** Code RB (Rezept-Bundle) hinzugefügt
 ...
 |22.12.2022 |01.07.2023 | bis einschl. Abrechnungsmonat 10/2024
