...
* *gematik* Definition der E-Rezept-Abgabeinformationen https://simplifier.net/erezept-abgabeinformationen
...
* Abrechnungszentren vollziehen den Profilwechsel zum 01.02.
...
|eRezept-Abrechnungs-daten  |ARZ erzeugt Abrechnungsdaten   |GKV-SV    |
        *1.2* + [1.0.2, 1.1.1, 1.2] |*1.2* + [1.0.2, 1.1.1, 1.2]      |*1.2* + [1.0.2, 1.1.1, 1.2]      |*1.2* + [1.0.2, 1.1.1, 1.2] (für Dez.) |*1.3* + [1.0.2/1.1.0, 1.2, 1.2/1.3] (für Jan.) +
                                                                                         *1.3* + [1.0.2/1.1.0, 1.2, 1.3] (für Feb.)        |*1.3* + [1.1.0, 1.2, 1.3] (für Mär.) |*1.3* + [1.1.0, 1.2, 1.3] (für Apr.++)
|eRezept-Abrechnungs-daten für PKV  |AVS erzeugt Abrechnungsdaten für Patient   |gematik    | | | |*1.0* |*1.0* |*1.0* |*1.0*
|===
