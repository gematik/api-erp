...
[source,bash]
----
java -jar validator_cli.jar ${FHIR_RESOURCE.XML} -ig de.gematik.erezept-workflow.r4-1.0.3-1.tgz -ig de.gematik.erezept-workflow.r4-1.1.1.tgz -ig de.basisprofil.r4-0.9.13.tgz -ig hl7.fhir.r4.core-4.0.1.tgz -ig kbv.ita.erp-1.0.1.tgz -ig kbv.ita.erp-1.0.2.tgz -ig kbv.basis-1.1.3.tgz -ig kbv.ita.for-1.0.3.tgz -version 4.0.1 -tx n/a
 FILE_UNDER_TEST.xml
----
