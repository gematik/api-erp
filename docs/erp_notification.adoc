...
[cols="h,a"] 
|===
|URI        |https://prescriptionserver.telematik/notifications/opt-in
|Method     |GET
|HTTP Header |
----
Authorization: Bearer eyJraWQ.ewogImL2pA10Qql22ddtutrvx4FsDlz.rHQjEmB1lLmpqn9J <1>
X-RegistrationToken: bk3RNwTe3H0:CI2k_HHwgIpoDKCIZvvDMExUdFQ3P1 <2> 
----
...
<2> Der X-Registration-Token transportiert das FCM-Registration-Token base64-codiert.
|Payload    | -
|===
...
[cols="h,a"] 
|===
|URI        |https://prescriptionserver.telematik//notifications/opt-out
|Method     |GET
|HTTP Header |
----
Authorization: Bearer eyJraWQ.ewogImL2pA10Qql22ddtutrvx4FsDlz.rHQjEmB1lLmpqn9J <1>
