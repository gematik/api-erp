...
Für **Rezepturen** müssen die Angaben zu Wirkstoff, Wirkstärke und Handelsname angegeben werden, wenn diese Information strukturiert im Verordnungsdatensatz vorliegen. Entsprechende Vorgaben sind in gemILF_PS_eRp zu finden.
...
Nach link:https://gemspec.gematik.de/docs/gemSpec/gemSpec_DM_eRp/gemSpec_DM_eRp_V1.10.0/#A_23384-01["A_23384-01 - E-Rezept-Fachdienst - Prüfung Gültigkeit FHIR Ressourcen"] wird die Gültigkeit der Profilversion nach dem jüngsten Datum aller MedicationDispense.whenHandedOver (max(.whenHandedOver)) bestimmt.
...
2. Das AVS beliefert den zweiten Teil der Verordnung am 22.04.
