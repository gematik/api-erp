...
[source,xml]
----
Unresolved directive in misc_api_endpoints-source.adoc - include::https://raw.githubusercontent.com/gematik/eRezept-Examples/feature/api-examples-wf-1.4.2/API-Examples/2025-01-15/misc_api_endpoints/CapabilityStatement_RU.xml[]
----
