...
| A | Konfiguration 2022, es werden nur bis 30.06.2023 gültigen Profile akzeptiert
| B | Konfiguration FHIR 2022 + 2023, der Fachdienst akzeptiert die aktuell gültigen und die ab 01.07.2023 in Kraft tretenden Profile
| C | Konfiguration 2023, der Fachdienst akzeptiert nur die ab 01.07.2023 in Kraft tretenden Profile
