...
NOTE: Ab 01.07.23 gelten weiterhin die 2022/2023er Profile, jedoch antwortet der Fachdienst nur gemäß 2023er Profil.
Ab 01.01.24 wird nur noch das 2023er Profil akzeptiert.
