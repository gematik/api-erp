...
* [small]#Prüfnachweis konnte nicht verifiziert werden#
* [small]#Das AVS hat einen veralteten Prüfnachweis vorgelegt, der außerhalb des erlaubten Zeitfensters erstellt wurde#
|===
